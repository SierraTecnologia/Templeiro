...
<html lang="{!! app('translation'::class)->getActualLanguage() !!}">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="{{ RiCaService::asset('css/app.css') }}">
    ...
    <script type="text/javascript" src="{{ RiCaService::asset('js/app.js', 'application/javascript') }}"></script>
