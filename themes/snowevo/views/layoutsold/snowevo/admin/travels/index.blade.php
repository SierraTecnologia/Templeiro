...
<div class="box panel card box-primary panel-primary card-primary">
	<div class="box-body panel-body card-body">
            <a class="btn btn-primary float-right" style="margin-top: -10px;margin-bottom: 5px" href="{{url('/admin/travels/create')}}"><i class="fa fa-plus fa-md" aria-hidden="true"></i> {{ trans('default.new') }}</a>
