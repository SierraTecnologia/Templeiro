...
@section('content')
    ...
    <div class="row">
        <a class="btn btn-primary pull-right" href="{!! route('siravel.blog.create') !!}">{!! trans('features.addNew') !!}</a>
                ...
                @foreach($blogs as $blog)
                    <tr>
                        ...
                        <td class="text-right">
                            ...
                            <a class="btn btn-xs btn-default pull-right raw-margin-right-8" href="{!! route('siravel.blog.edit', [$blog->id]) !!}"><i class="fa fa-pencil"></i> {!! trans('features.edit') !!}</a>
                        </td>
                    </tr>
                @endforeach
                </tbody>
