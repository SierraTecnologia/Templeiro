...
@section('content')
    ...
    <div class="row">
        <a class="btn btn-primary pull-right" href="{!! route('siravel.events.create') !!}">{!! trans('features.addNew') !!}</a>
                ...
                @foreach($events as $event)
                    <tr>
                        ...
                        <td class="text-right">
                            ...
                            <a class="btn btn-xs btn-default pull-right raw-margin-right-8" href="{!! route('siravel.events.edit', [$event->id]) !!}"><i class="fa fa-pencil"></i> {!! trans('features.edit') !!}</a>
                        </td>
                    </tr>
                @endforeach
                </tbody>
