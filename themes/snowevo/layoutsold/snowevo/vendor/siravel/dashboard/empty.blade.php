...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            <h1 class="page-header text-center">{!! trans('features.dashboard') !!}</h1>
                <p>The Siravel dashboard is powered by <b>Google Analytics</b> or by its own <b>Internal Analytics</b>.</p>
