...
<?php /*
    <link href='{!! \Templeiro::asset("css/app.css") !!}' rel='stylesheet' type='text/css'>
    <link href='{!! \Templeiro::asset("css/app_init.css") !!}' rel='stylesheet' type='text/css'>
    <link href='{!! \Templeiro::asset("vendor/bootstrap/css/bootstrap.min.css") !!}' rel="stylesheet">
    <!-- Font Awesome -->
    <link href='{!! \Templeiro::asset("vendor/font-awesome/css/font-awesome.min.css") !!}' rel="stylesheet">
    <!-- Nivo Lightbox -->
    <link href='{!! \Templeiro::asset("vendor/nivo-lightbox/nivo-lightbox.css") !!}' rel="stylesheet">
    <link rel="stylesheet" href='{!! \Templeiro::asset("vendor/nivo-lightbox/themes/default/default.css") !!}' type="text/css" />
    <!-- /Nivo Lightbox -->
    <!-- Perfect ScrollBar -->
    <link href='{!! \Templeiro::asset("vendor/perfect-scrollbar/css/perfect-scrollbar.min.css") !!}' rel="stylesheet">
    <!-- owl carousel -->
    <link href='{!! \Templeiro::asset("vendor/owl.carousel/owl-carousel/owl.carousel.css") !!}' rel="stylesheet">
    <link href='{!! \Templeiro::asset("vendor/owl.carousel/owl-carousel/owl.theme.css") !!}' rel="stylesheet">
    <!-- Main Styles -->
    <link href='{!! \Templeiro::asset("css/styles.css") !!}' rel='stylesheet' type='text/css'>
*/ ?>
    @themecss('app.css')
