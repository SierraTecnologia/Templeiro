...
<head>
    ...
    {!! Minify::stylesheet([
        ...
        Templeiro::asset('css/animate.min.css', 'text/css'),
...
<body>
    ...
    {!! Minify::javascript([
        ...
        Templeiro::asset('js/jquery.mb.YTPlayer.min.js', 'application/javascript'),
        Templeiro::asset('js/jquery.waypoints.min.js', 'application/javascript'),
        Templeiro::asset('js/jquery.counterup.min.js', 'application/javascript'),
