...
@if (!Auth::guest())
    <div class="wrapper">
        ...
        <header class="main-header">
            ...
            <!-- Logo -->
            <a href="#" class="logo">
                <b>{{ config('app.name', 'Sierra Tecnologia') }}</b>
            </a>
    ...
    <!-- Content Wrapper. Contains page content -->
        ...
        <footer class="main-footer" style="max-height: 100px;text-align: center">
            <strong>Copyright © 2017 <a href="http://sierratecnologia.com.br">SierraTecnologia</a>.</strong> All rights reserved.
        </footer>
    ...
    <nav class="navbar navbar-default navbar-static-top">
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="app-navbar-collapse">
                <!-- Left Side Of Navbar -->
                <ul class="nav navbar-nav">
                    <li><a href="{!! url('/home') !!}">{!! trans('words.home') !!}</a></li>
                </ul>

                <!-- Right Side Of Navbar -->
                <ul class="nav navbar-nav navbar-right">
                    <!-- Authentication Links -->
                    <li><a href="{!! url('/login') !!}">{!! trans('words.login') !!}</a></li>
                </ul>
            </div>
        </div>
    </nav>
