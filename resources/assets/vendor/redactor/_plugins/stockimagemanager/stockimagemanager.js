    ...
    $R.add('plugin', 'stockimagemanager', {
        ...
        modals: {
            'stockimagemanager': '<section id="redactor-modal-stockimagemanager">'
                ...
                + '<div id="stockimagemanager-links" class="raw-block-20 siravel-row"><button id="stockImgPrevBtn" class="btn btn-default float-left">Prev</button><button id="stockImgNextBtn" class="pull-right btn btn-default">Next</button></div>'
        ...
        insert: function(e)
        {
            ...
            $.ajax({
                ...
                url: _url + '/admin/api/images/store',
                error: function(data){
                    console.log(data)
                },
                success: $.proxy(function(data) {
