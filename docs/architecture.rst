...
Templeiro is a dead-simple PHP-MySQL application running git commands on your
repositories.
...
Templeiro does not backup automatically your repositories. As default,
repositories are located in ``app/repositories``. When setting up your
Templeiro platform, we recommend you to setup a backup on this folder, Templeiro
