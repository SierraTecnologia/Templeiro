...
Is Templeiro good enough for me?
-------------------------------

OK, let's be fair: Templeiro is still in early development.

We would love to conquer the world, make everybody use Templeiro, paint the
...
projects are more advanced than Templeiro:
...
Please consider them as you consider Templeiro. Templeiro is good for you if you're
a Symfony2 developer and will probably want some day to hack in it.

Can I push using username/password?
-----------------------------------

By now, Templeiro only works with SSH server using SSH keys. It's not possible to
...
I modified ``parameters.yml`` but I'm still getting errors from Templeiro. How to fix them?
------------------------------------------------------------------------------------------
